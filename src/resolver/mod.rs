...
pub async fn resolve_selection_parallelly<'a, T: SelectionSetResolver + ?Sized>(
    ctx: &SelectionSetContext<'a>,
    root_type: &'a T,
) -> ResolverResult<GqlValue> {
...
pub async fn resolve_selection_serially<'a, T: SelectionSetResolver + ?Sized>(
    ctx: &SelectionSetContext<'a>,
    root_type: &'a T,
) -> ResolverResult<GqlValue> {
    resolve_selection(ctx, root_type, false).await
}
async fn resolve_selection<'a, T: SelectionSetResolver + ?Sized>(
    ctx: &SelectionSetContext<'a>,
    root_type: &'a T,
    parallel: bool,
) -> ResolverResult<GqlValue> {
